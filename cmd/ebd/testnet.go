...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a ebd testnet",
...
Example:
	ebd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "ebd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "ebcli",
...
func InitTestnet(
	...
	tzConfig := srvconfig.DefaultConfig()
	tzConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to Peggy
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		tzConfigFilePath := filepath.Join(nodeDir, "config/ebd.toml")
		srvconfig.WriteConfigFile(tzConfigFilePath, tzConfig)
	}
